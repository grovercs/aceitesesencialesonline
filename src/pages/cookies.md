...
Las cookies son pequeños archivos de texto que los sitios web que visitas envían y almacenan en tu ordenador, teléfono inteligente o tableta. Se utilizan para que el sitio web funcione, o funcione de manera más eficiente, así como para proporcionar información analítica al titular del sitio.
...
Si bloqueas o eliminas las cookies técnicas estrictamente necesarias, es posible que el sitio web no se cargue correctamente o que algunas funciones dejen de estar disponibles.

## 4. Revocación del consentimiento

También puedes cambiar tu decisión y revocar el consentimiento del uso de cookies analíticas en nuestro sitio web en cualquier momento a través de los botones del banner de cookies interactivo que aparece en la parte inferior de la pantalla al acceder por primera vez o limpiando el almacenamiento de tu navegador para este dominio.
